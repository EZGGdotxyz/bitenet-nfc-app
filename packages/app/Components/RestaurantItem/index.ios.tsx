 ...
 * @LastEditors: yosan
 * @LastEditTime: 2024-03-25 16:23:15
 * @FilePath: /snapx-nfc-app/packages/app/Components/RestaurantItem/index.ios.tsx
 */
  ...
  return (
    ...
    >
      ...
      <LinearGradient
        ...
        locations={[0, 0.23, 0.4, 1]}
        colors={[
          'rgba(0, 0, 0, 0.44)',
          'rgba(203.73, 203.73, 203.73, 0.17)',
          'rgba(255, 255, 255, 0)',
          'rgba(0, 0, 0, 0.44)',
        ]}
      >
        <YStack pt={16} pl={16} pr={16}>
        ...
        <XStack pb={16} pl={16} pr={16} jc={'space-between'}>
          <YStack>
