 ...
 * @LastEditors: yosan
 * @LastEditTime: 2024-02-26 10:30:45
 * @FilePath: /snapx-nfc-app/packages/ui/src/block/appHeader/index.web.tsx
 */
'use client';
...
export function AppHeader({title, headerRight, headerLeft}: AppHeaderProps) {
  ...
  return (
    ...
    >
      ...
      {isFunction(title) ? title(titleStyle) : <Text {...titleStyle}>{title}</Text>}
